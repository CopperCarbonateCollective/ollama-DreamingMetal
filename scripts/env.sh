...
export GOFLAGS="'-ldflags=-w -s \"-X=github.com/CopperCarbonateCollective/ollama-DreamingMetal/version.Version=$VERSION\" \"-X=github.com/CopperCarbonateCollective/ollama-DreamingMetal/server.mode=release\"'"
