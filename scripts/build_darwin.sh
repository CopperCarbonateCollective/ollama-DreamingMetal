...
export GOFLAGS="'-ldflags=-w -s \"-X=github.com/CopperCarbonateCollective/ollama-DreamingMetal/version.Version=${VERSION#v}\" \"-X=github.com/CopperCarbonateCollective/ollama-DreamingMetal/server.mode=release\"'"
